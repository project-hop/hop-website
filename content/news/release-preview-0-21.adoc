...
We do have a great http://www.project-hop.org/docs/getting-started/[getting started] but our https://www.project-hop.org/manual/latest/[user manual] is currently falling a bit short.
