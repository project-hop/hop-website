...
We mentioned the addition of Hop Environments in the http://www.project-hop.org/news/roundup-2020-04/[April roundup] and the http://www.project-hop.org/news/release-preview-0-21/[0.21 release announcement].
...
Diethard and other community members (Rogier, Uwe, Hans) worked together and contributed their efforts to Project Hop.
