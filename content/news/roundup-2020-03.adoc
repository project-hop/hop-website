...
This program requires a local clone of the hop project, and will show you what has been translated and what is on the to-do list. Instructions on how to use the translator can be found in the http://www.project-hop.org/community/contribution-guides/translation-contribution-guide/[Translation Contribution Guide]


## Future

First up is our preview release! When this version is released we will rely on you all to create tickets and provide us with valuable feedback on how we can continue to improve the project.
